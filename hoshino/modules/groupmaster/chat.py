...
async def chat_alipay(bot,ev):
    ...
    record_path='E:/QQRobot/酷Q Pro_1/data/record/' #例：C:/QQRobot/酷Q Pro/data/record/
    opener=urllib.request.build_opener()
    opener.addheaders=[('User-Agent','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1941.0 Safari/537.36')]
    urllib.request.install_opener(opener)
    urllib.request.urlretrieve(f'https://mm.cqu.cc/share/zhifubaodaozhang/?money={ali_money}',f'{record_path}{ali_money}.mp3')
