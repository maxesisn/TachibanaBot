...
MODULES_ON = {
    ...
    #'dice',
    #'Genshin_Impact_bot',
    'GWYOG-Hoshino-plugins/bilisearchspider',
    'GWYOG-Hoshino-plugins/ngaclanbattlespider',
    'GWYOG-Hoshino-plugins/pcrsealkiller',
    'GWYOG-Hoshino-plugins/pcrmemorygames',
    'groupmaster',
    'hiumsentences',
    'hoshino_training',
    # 'hourcall',
